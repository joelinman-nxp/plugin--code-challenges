	...
	<form name="challenge_submissions" class="cc-form" id="cc_form" method="post" action="<?php echo '/wp-admin/admin-post.php' ?>">
		...
		<div class="row">
			<div class="form-group col-sm-6">
				...
				<input type="text" name="challenge_name" id="challenge_name" class="form-control challenge-fields">
			</div>
			<div class="form-group col-sm-6">
		...
		<div class="row">
			<div class="col-12">
				...
				<textarea name="challenge_desc" id="challenge_desc" class="form-control challenge-fields" rows="10" cols="50"></textarea>
			</div>
		</div>
		...
		<div class="row">
			<div class="form-group col-sm-6">
				...
				<input type="text" id="challenge_r" name="challenge_r" placeholder="e.g. u/Juggerz" class="form-control challenge-fields" >
			</div>
			<div class="form-group col-sm-6">
				<?php // submit form ?>
